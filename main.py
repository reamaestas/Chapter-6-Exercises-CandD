...
# C) Write conditional expressions to satisfy the following safety rules:
...
if shuttle_speed > 17500:
	...
	print("Alert: Connot maintain orbit!")
else:
	print("Stable speed")
	
# D) PREDICT: Do the code blocks shown in the Section D produce the same result?
